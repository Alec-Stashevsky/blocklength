...
`blocklength` is an R package used to automatically select the block-length parameter to perform a block-bootstrap on dependent data such as stationary time series.
